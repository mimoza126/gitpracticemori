...
/**
 * Servlet implementation class ExecuteRegisterServlet
 */
...
public class ExecuteRegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// セッションスコープのインスタンス取得
				...
				// 入力データの取得
				accountDTO kadai = (accountDTO)session.getAttribute("input_data");
				
				// 登録処理
				int result = account.registerAccount(kadai);
